...
def _dlog(msg: str, data: dict, hypothesis_id: str) -> None:
    ...
    try:
        with open(p, "a", encoding="utf-8") as f:
            f.write(json.dumps({"hypothesisId": hypothesis_id, "location": "pgvector_storage.py", "message": msg, "data": data, "timestamp": __import__("time").time() * 1000}, ensure_ascii=False) + "\n")
    except Exception:
        pass
# #endregion
